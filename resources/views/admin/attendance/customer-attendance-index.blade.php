@section('title', __('Customer attendances'))

@section('breadcrumb')
    <section class="py-3 px-4">
        <div class="flex flex-wrap items-center rtl:justify-start justify-between ">
            <div class="mb-5 lg:mb-0">
                <h2 class="mb-1 text-2xl font-bold">{{ __('Customer attendances') }}</h2>
                <div class="flex items-center">
                    ...
                    <a class="flex items-center text-sm" href="{{ route('customer-attendance.index') }}">
                        <span class="inline-block mx-2">
                        ...
                        <span>{{ __('Customer attendances') }}</span>
                    </a>
                </div>
            </div>
...
<x-app-layout>
    <x-card>
        <livewire:customer-attendance.index />
    </x-card>
</x-app-layout>
